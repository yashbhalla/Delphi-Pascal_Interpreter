...
public interface pascalListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link pascalParser#statementSequence}.
	 * @param ctx the parse tree
	 */
	void enterStatementSequence(pascalParser.StatementSequenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#statementSequence}.
	 * @param ctx the parse tree
	 */
	void exitStatementSequence(pascalParser.StatementSequenceContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link pascalParser#procedureAndFunctionDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterProcedureAndFunctionDeclaration(pascalParser.ProcedureAndFunctionDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#procedureAndFunctionDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitProcedureAndFunctionDeclaration(pascalParser.ProcedureAndFunctionDeclarationContext ctx);
}